...
public class UtilProp {
 ...
 //  static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\Scott Kratochvil\\workspace4830\\Generator2\\MyPantry\\WebContent\\config.properties";
   static String _PROP_FILENAME_WIN_LOCAL = "+MyPantry/src/config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/JokeGenerator/config.properties";
